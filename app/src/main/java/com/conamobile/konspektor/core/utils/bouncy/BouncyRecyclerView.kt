        ...
        context.theme.obtainStyledAttributes(attrs, R.styleable.BouncyRecyclerView, 0, 0)
            .apply {
                longPressDragEnabled =
                    getBoolean(R.styleable.BouncyRecyclerView_allow_drag_reorder, false)
                itemSwipeEnabled =
                    getBoolean(R.styleable.BouncyRecyclerView_allow_item_swipe, false)

                overscrollAnimationSize =
                    getFloat(R.styleable.BouncyRecyclerView_recyclerview_overscroll_animation_size,
                        0.5f)
                flingAnimationSize =
                ...
                return object : EdgeEffect(recyclerView.context) {
                    ...
                    private fun onPullAnimation(deltaDistance: Float) {
                        ...
                        forEachVisibleHolder { holder: ViewHolder? ->
                            if (holder is BouncyViewHolder) holder.onPulled(deltaDistance)
                        }
                    }
                    ...
                    override fun onAbsorb(velocity: Int) {
                        ...
                        forEachVisibleHolder { holder: ViewHolder? ->
                            if (holder is BouncyViewHolder) holder.onAbsorb(velocity)
                        }
                    }
